...
* [Syncing content](device-usage/syncing-content.md)
* [Exploring content](device-usage/exploring-content/README.md)
  * [Earth Defenders Toolkit](device-usage/exploring-content/earth-defenders-toolkit.md)
  * [Exploring the tools](device-usage/exploring-content/exploring-the-tools.md)
  * [Installing applications](device-usage/exploring-content/installing-applications.md)
* [Exploring featured tools](device-usage/exploring-featured-tools/README.md)
  * [Mapping and monitoring](device-usage/exploring-featured-tools/mapping-and-monitoring.md)
  * [Land-based storytelling](device-usage/exploring-featured-tools/land-based-storytelling.md)
* [Storing and sharing files](device-usage/storing-and-sharing-files/README.md)
  * [Storing files locally](device-usage/storing-and-sharing-files/storing-files-locally.md)
  * [Sharing files locally](device-usage/storing-and-sharing-files/sharing-files-locally.md)
  * [Sharing files online](device-usage/storing-and-sharing-files/sharing-files-online.md)
* [Customizing experience](device-usage/customizing-experience.md)
* [Managing device](device-usage/managing-device.md)
* [Getting support](device-usage/getting-support.md)
...
* [Device setup](introduction/device-setup.md)
  ...
  * [Using Docker](device-setup/device-setup/using-docker.md)
* [Support](device-setup/support.md)
